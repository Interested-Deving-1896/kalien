/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1f54823f27a4edfae2fd42d41c983934)
...
declare namespace Cloudflare {
	...
	interface MainnetEnv {
		...
		LEADERBOARD_TAPE_BACKFILL_MAX_PASSES: "4";
		LEADERBOARD_TAPE_BACKFILL_BATCH_SIZE: "100";
		LEADERBOARD_TAPE_BACKFILL_MAX_BATCHES: "20";
		LEADERBOARD_TAPE_BACKFILL_JOBS_PAGE_SIZE: "200";
		LEADERBOARD_TAPE_BACKFILL_MAX_JOBS_PER_CLAIMANT: "5000";
		LEADERBOARD_TAPE_BACKFILL_OLDEST_FIRST: "1";
		LEADERBOARD_TAPE_STALE_PRUNE_ENABLED: "1";
		LEADERBOARD_TAPE_STALE_PRUNE_BATCH_SIZE: "100";
		LEADERBOARD_TAPE_STALE_PRUNE_MAX_BATCHES: "20";
		LEADERBOARD_TAPE_STALE_PRUNE_OLDEST_FIRST: "1";
	...
	interface Env {
		...
		BOUNDLESS_POLL_TIMEOUT_MS: "600000";
		BOUNDLESS_CHAIN_ID: "8453";
		SCORE_CONTRACT_ID: "CDDAYXNY6MMA47Q54VSHG2WV445ZUOJ354NOLSFRC7ZUDTD6OTS4A7PE" | "CAKVUHDKKEG6SYUAVMQMDRMUGCNQJS74BP45NNYS7Y2TTYUMYFSLA7EU";
		CLAIM_NETWORK_PASSPHRASE: "Public Global Stellar Network ; September 2015" | "Test SDF Network ; September 2015";
		SMART_ACCOUNT_INDEXER_URL?: "https://smart-account-indexer-mainnet.sdf-ecosystem.workers.dev";
		LEADERBOARD_SYNC_CRON_ENABLED: "1";
		LEADERBOARD_SYNC_CRON_LIMIT: "400";
		LEADERBOARD_CATCHUP_INTERVAL_MINUTES: "30";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROVER_BASE_URL" | "PROVER_HEALTH_CACHE_MS" | "PROVER_POLL_INTERVAL_MS" | "PROVER_REQUEST_TIMEOUT_MS" | "ALLOW_INSECURE_PROVER_URL" | "MAX_TAPE_BYTES" | "MAX_PROOF_TOTAL_WALL_TIME_MS" | "MAX_PROVER_RUN_TIME_MS" | "COMPLETED_JOB_RETENTION_MS" | "RELAYER_URL" | "RELAYER_PLUGIN_ID" | "RELAYER_REQUEST_TIMEOUT_MS" | "BOUNDLESS_RPC_URL" | "BOUNDLESS_IMAGE_URL" | "BOUNDLESS_IMAGE_ID" | "BOUNDLESS_MAX_PRICE_USD" | "BOUNDLESS_MIN_PRICE_USD" | "BOUNDLESS_TOP_UP_BUFFER_BPS" | "BOUNDLESS_FLAT_PERIOD_SEC" | "BOUNDLESS_RAMP_PERIOD_SEC" | "BOUNDLESS_LOCK_TIMEOUT_SEC" | "BOUNDLESS_TIMEOUT_SEC" | "BOUNDLESS_POLL_TIMEOUT_MS" | "BOUNDLESS_CHAIN_ID" | "SCORE_CONTRACT_ID" | "CLAIM_NETWORK_PASSPHRASE" | "SMART_ACCOUNT_INDEXER_URL" | "LEADERBOARD_SYNC_CRON_ENABLED" | "LEADERBOARD_SYNC_CRON_LIMIT" | "LEADERBOARD_CATCHUP_INTERVAL_MINUTES" | "LEADERBOARD_CATCHUP_WINDOW_LEDGERS" | "LEADERBOARD_FORWARD_REPLAY_WINDOW_LEDGERS" | "LEADERBOARD_TAPE_BACKFILL_ENABLED" | "LEADERBOARD_TAPE_BACKFILL_MAX_PASSES" | "LEADERBOARD_TAPE_BACKFILL_BATCH_SIZE" | "LEADERBOARD_TAPE_BACKFILL_MAX_BATCHES" | "LEADERBOARD_TAPE_BACKFILL_JOBS_PAGE_SIZE" | "LEADERBOARD_TAPE_BACKFILL_MAX_JOBS_PER_CLAIMANT" | "LEADERBOARD_TAPE_BACKFILL_OLDEST_FIRST" | "LEADERBOARD_TAPE_STALE_PRUNE_ENABLED" | "LEADERBOARD_TAPE_STALE_PRUNE_BATCH_SIZE" | "LEADERBOARD_TAPE_STALE_PRUNE_MAX_BATCHES" | "LEADERBOARD_TAPE_STALE_PRUNE_OLDEST_FIRST" | "RELAYER_API_KEY" | "STELLAR_RPC_URL" | "DEV_API_KEY" | "PROVER_EXPECTED_IMAGE_ID" | "BOUNDLESS_PRIVATE_KEY" | "PINATA_JWT" | "GALEXIE_API_KEY">> {}
}
