  ...
  return (
    <div className="absolute inset-0 z-10 flex items-center justify-center bg-[rgba(3,7,14,0.82)] backdrop-blur-sm">
      <div className="w-full max-w-sm px-4">
        <div className="flex max-h-[calc(100%-1rem)] flex-col gap-3 overflow-y-auto rounded-xl border border-[rgba(122,185,255,0.25)] bg-[radial-gradient(circle_at_12%_8%,rgba(94,165,255,0.12),transparent_42%),linear-gradient(160deg,rgba(8,16,29,0.92),rgba(6,13,24,0.98))] p-[clamp(0.8rem,2vw,1.2rem)] shadow-[0_24px_80px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.06)]">
          ...
          {showSuccessBanner && (
            <div className="flex flex-col items-center gap-2 rounded-lg border border-secondary/30 bg-[rgba(26,108,71,0.15)] px-3 py-3 text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2">
                ...
                <Button variant="space" size="sm" asChild>
                  <a href="/leaderboard" className="no-underline">
                    <ExternalLink className="size-3.5" />
                    Leaderboard
                  </a>
                </Button>
