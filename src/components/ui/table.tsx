...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="table-scroll-hint relative w-full overflow-x-auto rounded-lg border border-[rgba(96,152,224,0.28)]"
    >
      <table
        data-slot="table"
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-[rgba(104,161,237,0.2)] transition-colors",
        className
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "px-2 py-2.5 text-left align-top whitespace-nowrap",
        className
      )}
      {...props}
    />
