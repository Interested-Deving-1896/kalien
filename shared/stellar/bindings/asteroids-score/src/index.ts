...
export interface Client {
   ...
   */
  best_score: (
    { claimant, seed_id }: { claimant: string; seed_id: u32 },
    options?: MethodOptions,
   ...
   */
  is_claimed: (
    { journal_digest }: { journal_digest: Buffer },
    options?: MethodOptions,
  ...
  current_seed: (
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<CurrentSeed>>;
   ...
   */
  set_image_id: (
    { new_image_id }: { new_image_id: Buffer },
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<null>>;
   ...
   */
  set_token_id: (
    { new_token_id }: { new_token_id: string },
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<null>>;
   ...
   */
  submit_score: (
    { seal, journal_raw }: { seal: Buffer; journal_raw: Buffer },
    options?: MethodOptions,
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
    /** Constructor/Initialization Args for the contract's `__constructor` method */
    {
      ...
      image_id,
      token_id,
    }: { admin: string; router_id: string; image_id: Buffer; token_id: string },
    ...
    return ContractClient.deploy(
      { admin, router_id, image_id, token_id },
      options,
    );
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "",
